...
void Game::play(Player *player1, Player *player2)
{
    ...
    if (mode == "double")
    {
        while (!end)
        {
            ...
            move(player1);
            cout << player1->getName() << "当前得分为：" << player1->score << endl;
            cout << endl;
            if (end)
            {
                break;
            ...
            move(player2);
            cout << player2->getName() << "当前得分为：" << player2->score << endl;
            cout << endl;
        }
        cout << "游戏结束! " << endl;
        if (player1->score != player2->score)
        {
            cout << ((player1->score > player2->score) ? player1->getName() : player2->getName());
            cout << "获胜!" << endl;
        }
        else
        {
